...
function question1() {var q1 = prompt('Some people think I like cats. But am I really a dog person?');
...
function question2() {var q2 = prompt('Is my favorite food pizza?');
...
function question3() {var q3 = prompt('Do you think I voted for Lyndon Larouche in the presidential election last year?');
...
function question4() {var q4 = prompt('ROCK PAPER SCISSORS SHOOT. \n \n \n \n \n \n \n \n \nI picked rock. Did I win?');
...
function question5() {var q5 = prompt('Is my favorite David Bowie album Ziggy Stardust and the Spiders from Mars?');
...
function question6() {for (i = 0; i < 4; i++) { //This is the sequence where they have 4 tries to guess the number and receive hints.
...
function question7() {for (i = 0; i < 6; i++) {
